...
//float RightSlenderCtlPoint[] = {477, 509};//右侧控制点
 float LeftCheekKeyPoint[] = {face_data[0], face_data[1]};//左脸颊关键点
float ChinKeyPoint[] = {face_data[24], face_data[25]};//下巴关键点
float RightCheekPoint[] = {face_data[48], face_data[49]};//右脸颊关键点
float LeftSlenderCtlPoint[] = {face_data[12]- 10, face_data[13]  };//左侧控制点
float RightSlenderCtlPoint[] = {face_data[36] + 10, face_data[37] };//右侧控制点
